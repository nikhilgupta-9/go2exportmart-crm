const toolhide = document.querySelector('#tool_hide');
const dashtool = document.querySelector('#tool-div');
toolhide.addEventListener("click", ()=>{
    dashtool.classList.remove('d-none');
})
