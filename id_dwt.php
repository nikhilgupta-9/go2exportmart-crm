...
$company_website = "https://digitalwebtrackers.com";
?>
...
<head>
    ...
    <title>Digital Web Trackers - Digital ID Card</title>
    ...
    <div class="digital-id-card">
        <div class="card-header">
            <div class="company-badge">
                <img src="assets/img/dwt-logo.png" alt="Digital Web Trackers" onerror="this.src='https://via.placeholder.com/28?text=DWT'">
                <span>Digital Web Trackers</span>
            </div>
            <div class="card-type">
        ...
        <div class="photo-section">
            <div class="photo-frame">
                ...
                <?php else: ?>
                    <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($employee['user_name']); ?>&background=f5576c&color=fff&size=110&bold=true&length=2" alt="Employee Photo">
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-content">
                    ...
                    <div class="info-value">DWT-<?php echo str_pad($employee['emp_id'], 5, '0', STR_PAD_LEFT); ?></div>
                </div>
            ...
            <div class="info-item">
                ...
                <div class="info-content">
                    ...
                    <div class="info-value"><?php echo $tenure->y; ?> Years <?php echo $tenure->m; ?> Months</div>
                </div>
            </div>
        ...
        <div class="qr-section">
            ...
            <div class="qr-text">
                <i class="ti ti-qrcode"></i> Scan QR to visit Digital Web Trackers
            </div>
        </div>
        ...
        <div class="card-footer">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div style="text-align: center;">
                    ...
                    <small style="font-size: 10px; color: #64748b;">Employee Signature</small>
                </div>
                <div style="text-align: center;">
                    <div class="signature-line"></div>
                    <small style="font-size: 10px; color: #64748b;">HR Manager</small>
                </div>
            </div>
            <div style="margin-top: 12px;">
                <small style="font-size: 9px; color: #94a3b8;">
                    <i class="ti ti-calendar-due"></i> Issue Date: <?php echo date('d M Y'); ?>
                </small>
            </div>
        </div>
