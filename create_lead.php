...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['create_lead'])) {
    ...
    if ($conn->query($insert_sql)) {
        ...
        $call_log_sql = "INSERT INTO call_logs (lead_id, call_status, follow_up_date, call_notes, source, created_by, created_at) 
                         VALUES ('$lead_id', '$call_status', " . ($follow_up_date ? "'$follow_up_date'" : "NULL") . ", '$call_notes', '$lead_source', '$user_id', NOW())";
                ...
                <form action="" method="POST" id="leadForm" novalidate>
                    ...
                    <div class="form-section">
                        <h5 class="section-title">
                            <i class="ti ti-source-code"></i> Lead Source
                        </h5>
                        <div class="row">
                            <div class="col-md-12">
                                <label class="form-label required-field">Where did you get this lead from?</label>
                                <div class="row g-3">
                    ...
                    <!-- Customer Information Section (Required) -->
                    <div class="form-section">
                        <h5 class="section-title">
                            <i class="ti ti-user"></i> Basic Customer Information <span class="text-danger">*Required</span>
                        </h5>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label required-field">Customer Number</label>
                                ...
                                <div class="info-text">10-digit mobile number starting with 6,7,8, or 9</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="ti ti-world-wide-web"></i></span>
                            ...
                            <div class="col-md-6">
                                <label class="form-label optional-field">Email Address</label>
                                <div class="input-group">
                    ...
                    <div class="form-section">
                        <h5 class="section-title">
                            <i class="ti ti-map-pin"></i> Address Information <span class="text-muted">(Optional - Can be updated later)</span>
                        </h5>
                        <div class="row g-3">
                            <div class="col-12">
                                <label class="form-label optional-field">Address</label>
                                <textarea class="form-control" name="cust_address" rows="2"
                                          placeholder="Street Address, Area, Landmark (Optional)"></textarea>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="cust_pincode" 
                                       pattern="[0-9]{6}" maxlength="6" placeholder="123456 (Optional)">
                            </div>
                            ...
                            <div class="col-md-6">
                                <label class="form-label optional-field">PAN Number</label>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="form-label required-field">Call Status</label>
                                <div class="row g-3">
                            ...
                            <div class="col-md-6" id="followUpDateDiv" style="display: none;">
                                ...
                                <div class="info-text">Schedule follow up for this lead</div>
                            </div>

                            <div class="col-12">
                                <label class="form-label optional-field">Call Notes / Remarks</label>
                                <textarea class="form-control" name="call_notes" rows="3" 
                                          placeholder="Enter call notes, customer requirements, objections, etc..."></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section text-center">
                        <button type="submit" name="create_lead" class="btn btn-primary btn-submit">
                            <i class="ti ti-device-floppy me-2"></i> Create Lead
                        </button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.status-card').click(function() {
                ...
                // Show payment modal for payment_done
                if (status === 'payment_done') {
                    if (confirm('Payment done? Please enter payment details.')) {
        ...
        document.getElementById('customer_num')?.addEventListener('input', function(e) {
